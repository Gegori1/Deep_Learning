...
class BoxPlotter:
    def __init__(self, model, data, threshold=0.5, grid_size=4, resize_size=..., device=...):
        self.model = model
        self.data = data
    ...
    def inference_one_image(self, image_idx):
        ...
        pred_box = pred_box.reshape(self.grid_size, self.grid_size, 5*2)

        pred_box_1 = pred_box[..., :5]
        pred_box_2 = pred_box[..., 5:]
